        ...
        if (session.getAttribute("loggedIn") == null ||
            ...
            if (session.getAttribute("loggedIn") != null &&
                ...
                if(request.getParameter("submit")!=null && request.getParameter("submit").equals("submit")){
                    ...
                    user.setUrlFotoProfilo((String)request.getAttribute("immagine"));
                    user.setFrasePresentazione((String)request.getAttribute("frase"));
                    user.setDataDiNascita((String)request.getAttribute("nascita"));
                    user.setPassword((String)request.getAttribute("password1")); 
                }
